...
export default {
  data() {
    return {
      ...
      iconNews: {
        normal: require('@/assets/tabbar/news_normal.png'),
        active: require('@/assets/tabbar/news_active.png')
      },
      iconShare: {
        normal: require('@/assets/tabbar/share_normal.png'),
        active: require('@/assets/tabbar/share_active.png')
      },
      iconMy: {
